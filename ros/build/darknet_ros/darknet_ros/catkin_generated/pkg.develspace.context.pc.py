...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/capstone/ros/src/darknet_ros/darknet_ros/include;/usr/include".split(';') if "/capstone/ros/src/darknet_ros/darknet_ros/include;/usr/include" != "" else []
